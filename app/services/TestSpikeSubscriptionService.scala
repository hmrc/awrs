...
object TestSpikeSubscriptionService extends TestSpikeSubscriptionService {
  ...
  override val enrolService: TestSpikeEnrolService = TestSpikeEnrolService
}
// $COVERAGE-OFF$
trait TestSpikeSubscriptionService {
  ...
  val metrics: Metrics
  val enrolService: TestSpikeEnrolService
