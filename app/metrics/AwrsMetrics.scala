...
object AwrsMetrics extends AwrsMetrics {
  ...
  val timers = Map(
    ...
    ApiType.API6UpdateSubscription -> metrics.defaultRegistry.timer("api5-update-subscription-response-timer"),
  ...
  val successCounters = Map(
    ...
    ApiType.API6UpdateSubscription -> metrics.defaultRegistry.counter("api5-update-subscription-success"),
  ...
  val failedCounters = Map(
    ...
    ApiType.API6UpdateSubscription -> metrics.defaultRegistry.counter("api5-update-subscription-failed"),
